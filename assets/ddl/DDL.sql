...
CREATE TABLE `file` (
                ...
                `url`               VARCHAR(255)    NOT NULL COMMENT 'S3 파일 URL',
                `type`              VARCHAR(10)     NOT NULL COMMENT '파일 형식 (PNG, CSV, XLSX, HWP, PDF, JPEG)',
...
CREATE TABLE `employee` (
                ...
                `emp_no`                    VARCHAR(30)     NOT NULL COMMENT '사번',
...
CREATE TABLE `appoint` (
                ...
                `before_department` INT     NOT NULL COMMENT '발령전부서ID',
                `after_department`  INT     NOT NULL COMMENT '발령후부서ID',
...
CREATE TABLE `position` (
                ...
                `name`          VARCHAR(30)     NOT NULL UNIQUE COMMENT '직위명',
...
CREATE TABLE `approve_receipt` (
                ...
                `used_at`               DATETIME        NOT NULL COMMENT '거래 일시',
...
CREATE TABLE `work_correction` (
                ...
                `reason`                VARCHAR(255)    NOT NULL COMMENT '정정 사유',
...
CREATE TABLE `vacation` (
                ...
                `reason`            VARCHAR(255)    DEFAULT NULL COMMENT '휴가 사유',
...
CREATE TABLE `overtime` (
                ...
                `break_time`    INT             NOT NULL COMMENT '휴게시간',
                `reason`        VARCHAR(255)    NOT NULL COMMENT '초과근무 사유',
...
CREATE TABLE `business_trip` (
                ...
                `start_date`        DATE            NOT NULL COMMENT '시작일',
                `end_date`          DATE            NOT NULL COMMENT '종료일',
                `reason`            VARCHAR(255)    NOT NULL COMMENT '출장 사유',
...
CREATE TABLE `kpi` (
                ...
                `c_reason`      VARCHAR(255)    DEFAULT NULL COMMENT '취소 처리 사유',
...
CREATE TABLE `hr_weight` (
               ...
               `team_wt`       INT  NOT NULL COMMENT '조직 기여 및 협업 행동 가중치',
               `attitude_wt`   INT  NOT NULL COMMENT '자기관리 및 태도 가중치',
               `immersion_wt`  INT  NOT NULL COMMENT '업무 태도 및 몰입도 가중치',
               `result_wt`     INT  NOT NULL COMMENT '정량 성과 및 목표관리 가중치',
               `adjust_wt`     INT  NOT NULL COMMENT '보정 점수 가중치',
...
CREATE TABLE `retention_support` (
                ...
                `emp_id`                BIGINT      NOT NULL COMMENT '사원 ID',
                `round_id`              INT         NOT NULL COMMENT '회차 ID',
                `rating_score`          INT         NOT NULL COMMENT '인사 평가 점수',
                `peer_score`            INT         NOT NULL COMMENT '다면 평가 점수',
                `performance_score`     INT         NOT NULL COMMENT '성과 평가 점수',
                `attend_score`          INT         NOT NULL COMMENT '근태 평가 점수',
                `retention_score`       INT         NOT NULL COMMENT '근속 지수',
                `created_at`            DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성 일시',
...
CREATE TABLE `retention_insight` (
                ...
                `position_id`       INT         DEFAULT NULL COMMENT '직급 ID',
                `round_id`          INT         NOT NULL COMMENT '회차 ID',
...
CREATE TABLE `notification_template` (
            `notification_template_id`  INT             NOT NULL AUTO_INCREMENT COMMENT '알림 템플릿 ID',
  ...
  DEFAULT CHARSET=utf8mb4
  COLLATE=utf8mb4_general_ci
  COMMENT='결재, 평가, 근속 지원에 대한 알림 메시지 템플릿을 저장하는 테이블';
...
CREATE TABLE `notification` (
                ...
                `notification_template_id`  INT             NOT NULL COMMENT '알림 템플릿 ID',
                `approve_id`                BIGINT          DEFAULT NULL COMMENT '결재 ID',
                `contact_id`                BIGINT          DEFAULT NULL COMMENT '면담 기록 ID',
                `content`                   VARCHAR(50)     NOT NULL COMMENT '알림 내용',
